  ...
  return (
    <section className="w-full bg-blue-950">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-4 px-4 py-3 sm:px-6 md:flex-row md:items-center md:justify-between md:gap-6">
        ...
        <a
          href="tel:0981543342"
          className="mx-auto inline-flex min-w-[156px] items-center gap-2 whitespace-nowrap rounded-md bg-white px-4 py-2 text-sm font-semibold text-slate-900 md:mx-0"
